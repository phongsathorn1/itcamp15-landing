      ...
      <div class="row location-wrapper">
        <div class="col-md-5">
          <ul class="transportation-list">
            <li>
              <div class="li-head">Airport Rail Link</div>ลงสถานีลาดกระบัง จากนั้นต่อรถไฟสายตะวันออกที่สถานีลาดกระบัง มาลงที่สถานีพระจอมเกล้า หรือต่อรถสองแถวสาย 777 (เขียนว่าเข้าเทคโนฯ)
            </li>
            <li>
