      ...
      camps: [
        {
          ...
          logo: 'app.png',
          color: '#1fb4ec',
          detail: `Appermort จะพาคุณมารู้จักกับจอมวายร้ายที่คุณอาจยังไม่รู้ตัว ที่เป็นต้นเหตุหลักทำให้เหล่าผู้คน ติดมือถือกันจนงมงาย เราจะสอนศาสตร์มืดเหล่านี้ให้คุณ นำไปเผยแพร่และ<b>ดึงดูดผู้คน</b>ที่เป็นเป้าหมาย<b>ให้มาติดกับดัก Application iOS ของเรา ด้วยภาษา Swift ผ่านโปรแกรม Xcode จนต้องเปย์ตัว เปย์ใจ ให้กับ App ของคุณ</b> มาสิ ตามพวกเรามาสิ แล้วคุณจะเป็นผู้สร้างโลกใบใหม่นี้ด้วยตัวคุณเอง ... ฮ่า ๆ ๆ
`
        },
        {
          id: 'network',
          ...
          logo: 'network.png',
          color: '#d61732',
          detail: `เวทมนตร์แห่งการเชื่อมต่อที่ไม่มีสิ้นสุดจะนำพาให้เราได้มารู้จักกัน ใน Netherine จะพาน้อง ๆ ไป<b>ไขปริศนาของเทคโนโลยีการเชื่อมต่อระหว่างอุปกรณ์</b> จนเกิดขึ้นเป็นเครือข่าย อะไรทำให้เหล่าอุปกรณ์วิเศษเหล่านี้สามารถแลกเปลี่ยนข้อมูลกันได้ แต่ละอุปกรณ์รู้จักกันได้อย่างไร ที่นี่มีคำตอบ!!
          `
        },
        {
          id: 'game',
...
`
        },
        {
          ...
          logo: 'data.png',
          color: '#9013fe',
          detail: `พร้อมรึยังกับค่าย Dragota ศาสตร์ที่จะนำข้อมูลอันสุดแสนจะธรรมดาเปลี่ยนให้กลายเป็น<b>การพยากรณ์อนาคตที่น่าเหลือเชื่อด้วย Rapidminer</b> ดั่งเวทย์มนต์ที่รังสรรค์สิ่งมหัศจรรย์ที่ไม่รู้จบ พี่ ๆ พร้อมที่จะมอบความรู้ ความอบอุ่น และความสนุกให้แบบไม่อั้น แล้วน้อง ๆ จะรู้ว่าข้อมูลรอบตัวเรานั้นสามารถทำอะไรได้มากกว่าที่คิด!
          `
        },
        {
          id: 'iot',
          ...
          logo: 'iot.png',
          color: '#f5a623',
          detail: `“เมื่ออินเตอร์เน็ตสามารถเข้าถึงสิ่งต่างๆที่มีอยู่รอบๆตัวเราจะดีเท่าไหนกัน หากเราสามารถเสกเวทมตร์ควบคุบเครื่องใช้ไฟฟ้าให้มันเป็นดั่งใจเราได้” ศาสตร์แห่ง Dobby of Things จะพาน้องๆพบเจอกับเวทมนตร์ Arduino IDE, VS Code และอื่น ๆ อีกมากมายที่จะช่วยให้เราสะดวกสบายมากยิ่งขึ้น 
<b>ให้อินเทอร์เน็ตเปรียบเสมือน Dobby ประจําบ้านของน้อง ๆ</b>`
        }
      ],
