...
`
        },
        {
          ...
          logo: 'network.png',
          color: '#d61732',
          detail: `เวทมนตร์แห่งการเชื่อมต่อที่ไม่มีสิ้นสุดจะนำพาให้เราได้มารู้จักกัน 
ใน Netherine จะพาน้อง ๆ ไปไขปริศนาของเทคโนโลยีการเชื่อมต่อระหว่างอุปกรณ์ จนเกิดขึ้นเป็นเครือข่าย อะไรทำให้เหล่าอุปกรณ์วิเศษเหล่านี้สามารถแลกเปลี่ยนข้อมูลกันได้ แต่ละอุปกรณ์รู้จักกันได้อย่างไร ที่นี่มีคำตอบ!!
          `
        },
        {
          id: 'game',
          ...
          logo: 'game.png',
          color: '#6c980d',
          detail: `"หากว่าเป็นผู้เล่นจนพอใจแล้ว ลองมาเป็นผู้สร้างดูไหม ?" น้องๆ จะได้เรียนรู้จากศาสตร์นี้ เกี่ยวกับการสร้างเกม รู้ว่าเกมหนึ่งเกมควรจะมีอะไรบ้าง และ 
วิธีที่จะถ่ายทอดจินตนาการของน้อง ๆ สู่เกมที่เราสามารถเล่นได้จริง ด้วยโปรแกรม Construct 2 ที่ใช้งานได้ง่ายเข้าใจไม่ยาก เพราะความสนุกไม่ได้มีแค่ตอนเล่นเกม 
มาเป็นส่วนหนึ่งในค่าย GrindelGame และสร้างสรรค์เกมไปด้วยกัน!
`
        },
        {
          id: 'data',
          ...
          logo: 'data.png',
          color: '#9013fe',
          detail: `พร้อมรึยังกับค่าย Dragota ศาสตร์ที่จะนำข้อมูลอันสุดแสนจะธรรมดาเปลี่ยนให้กลายเป็นการพยากรณ์อนาคตที่น่าเหลือเชื่อด้วยRapidminer ดั่งเวทย์มนต์ที่รังสรรค์สิ่งมหัศจรรย์ที่ไม่รู้จบ พี่ ๆ พร้อมที่จะมอบความรู้ ความอบอุ่น และความสนุกให้แบบไม่อั้น แล้วน้อง ๆ จะรู้ว่าข้อมูลรอบตัวเรานั้นสามารถทำอะไรได้มากกว่ที่คิด!
          `
        },
        {
          id: 'iot',
          ...
          logo: 'iot.png',
          color: '#f5a623',
          detail: `“เมื่ออินเตอร์เน็ตสามารถเข้าถึงสิ่งต่างๆที่มีอยู่รอบๆตัวเราจะดีเท่าไหนกัน หากเราสามารถเสกเวทมตร์ควบคุบเครื่องใช้ไฟฟ้าให้มันเป็นดั่งใจเราได้” ศาสตร์แห่ง Dobby of Things จะพาน้องๆพบเจอกับเวทมนตร์Arduino IDE, VS Code และอื่น ๆ อีกมากมายที่จะช่วยให้เราสะดวกสบายมากยิ่งขึ้น ให้อินเทอร์เน็ตเปรียบเสมือน Dobby ประจําบ้านของน้อง ๆ`
        }
      ],
